        ...
        <div id="create-application">
            ...
            <form onSubmit={onSubmit}>
                ...
                <div>
                    ...
                    <input type="radio" id="email" name="communication" value="Email" required onChange={handleChange} />
                    <label htmlFor="email">Email</label>
                    <input type="radio" id="phone" name="communication" value="Phone" onChange={handleChange} />
